...
public class TestProject {
	...
	public static void doReg() {
		...
		do {
			...
			case 1:
				...
				do{
					...
					case 1:
						...
						/*
						 * boolean check = service.register(bean); if(check) {
						 * System.out.println("Registered"); } else {
					...
					case 2:
						...
						try {
							//UsersBean authBean = service.auth(email, password);
							//AdminServiceDAO service = AdminFactory.getAdminServiceDAO();
							UsersDAO usersService = UserFactory.getUsersDAO();
			...
			case 2:
				UsersService service1 = StudentFactory.getStudentServiceDAO();
				do {
					System.out.println("-----------------------------------");
